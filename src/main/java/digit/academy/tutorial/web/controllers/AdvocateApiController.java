...
@jakarta.annotation.Generated(value = "org.egov.codegen.SpringBootCodegen", date = "2025-06-02T12:49:31.618584800+05:30[Asia/Calcutta]")
@RestController
...
public class AdvocateApiController {
    ...
    public ResponseEntity<AdvocateResponse> searchAdvocates(@Valid @RequestBody AdvocateSearchRequest body) {
        log.info("Request received to Search Advocate: {}", body);
    ...
    public ResponseEntity<AdvocateResponse> updateAdvocate(@Valid @RequestBody AdvocateRequest body) {
        log.info("Request received to Update Advocate: {}", body);
    ...
    public ResponseEntity<AdvocateClerkResponse> createClerk(@Valid @RequestBody AdvocateClerkRequest body) {
        ...
        AdvocateClerk clerk = advocateClerkService.createClerk(body.getAdvocateClerk(), body.getRequestInfo());
